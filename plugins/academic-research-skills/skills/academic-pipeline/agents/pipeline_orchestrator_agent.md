...
| Stage 2 -> 2.5 | Complete Paper Draft assembled from confirmed section files | Schema 4 (Paper Draft) | Pass to integrity_verification_agent only after section coverage is complete |
